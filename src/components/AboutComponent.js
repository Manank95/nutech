		...
		return (
            ...
            care of your body, so that you can heal quickly. <br /> <br />
              ...
              experience in distribution and sales.</p>
								...
								<a href="https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0088841" target="_blank" className="btn btn-dark btn-outline btn-rounded scroll-to">Find out More</a>
							</div>
						</div>
					</section>
						...
						<div className="row">
							<div style={{ backgroundColor: '#917d5d' }} className="col-md-4">
								...
								<span>The cost of prostate cancer treatment in India can add up to lakhs of rupees and no guarantee of 100%
									...
									threat of
            prostate cancer? SeroMark-1 test costs only Rs. 4000. </span>
							</div>
            ...
            that power to decide."</span>
                  ...
                  results, your doctor would then talk to you about treatment options. <br />With active surveillance,
												your
					...
					<section>
						<div className="container">
							...
							<a href="./downloads/Business_Organization_2019.tif">
								<div role="alert" className="alert alert-info"><i className="fa fa-download" /> <strong>Business Organization 2019</strong> </div>
							</a>
							<a href="./downloads/PROSTATE_HEALTH_AWARENESS-EASILY_UNDERSTANDABLE.pdf">
								<div role="alert" className="alert alert-info"><i className="fa fa-download" /> <strong>PROSTATE_HEALTH AWARENESS-EASILY UNDERSTANDABLE</strong></div>
							</a>
							<a href="./downloads/Prostate_Health_in_Hindi.pdf">
								<div role="alert" className="alert alert-info"><i className="fa fa-download" /> <strong>Prostate Health in Hindi</strong> </div>
							</a>
							<a href="./downloads/Brochure_July_1_2019.pdf">
								<div className="alert alert-info"><i className="fa fa-download" /> <strong>Brochure July 1, 2019</strong></div>
							</a>
							<a href="./downloads/Brochure_May_1_2019.pdf">
								<div className="alert alert-info"><i className="fa fa-download" /> <strong>Brochure May 1, 2019</strong> </div>
							</a>
							<a href="./downloads/Brochure_March_1_2019.pdf">
								<div className="alert alert-info"><i className="fa fa-download" /> <strong>Brochure March 1, 2019</strong> </div>
							</a>
							{/* end: Testimonials */}
						</div>
					</section>
									...
									<div className="col-md-2">
										...
										<div className="widget">
											...
											<ul className="list-icon list-icon-arrow">
												<li><a href="#">Home</a></li>
												<li><a href="#section2" className="scroll-to">About</a></li>
